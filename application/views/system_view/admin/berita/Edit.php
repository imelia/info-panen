                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="card card-plain table-plain-bg">
                                ...
                                <form action="<?=base_url()?>berita/updatedata" method="post" enctype="multipart/form-data">
                                <div class="row">
                                      <div class="col-md-12">
                                      <label>Gambar</label>
                                          <div class="form-group">
                                              ...
                                              <!-- file lama -->
                                                <input type="hidden" name="filelama" value="<?=$data->nama_gambar?>" required>
                                                    <!-- ID -->
                                                <input type="hidden" name="id" value="<?=$data->id_berita?>" required>
                                          </div>
                                      </div>
                                  </div>
