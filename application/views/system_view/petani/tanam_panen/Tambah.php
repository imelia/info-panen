                        ...
                        <div class="card-body table-full-width table-responsive">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <?php
                                    if (!empty($komo)) { ?>
                                        <input list="komoditas" id="komoditas1" name="komoditi" class="form-control" Placeholder="Masukkan komoditas" required>
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <label>Stok</label>
                                    <div class="form-group">
                                        <input type="number" name="stok_tanam" class="form-control" Placeholder="Stok Tanaman">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
