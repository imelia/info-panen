    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-md-9 col-md-offset-3">
                <form action="<?= base_url('Dash_petani/update_rekening') ?>" method="post">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <input type="hidden" name="id_rekening" id="id_rekening" value="<?= $query->id_rekening; ?>">
                                        <input type="text" name="nama_bank" value="<?= $query->nama_bank; ?>" class="form-control">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="nomor_rekening" value="<?= $query->nomor_rekening; ?>" class="form-control">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="nama_pemilik" value="<?= $query->nama_pemilik; ?>" class="form-control">
