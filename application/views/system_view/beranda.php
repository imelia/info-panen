    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="container-fluid">
          ...
          <!-- Content Row -->
          <div class="card shadow p-5" style="height: 200%;">
            <!-- Content Row -->
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col text-center">
                        <p class="btn btn-sm btn-info p-2 mb-5 text-white text-center">Komoditi : <span>Sisi Bawah</span></p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class=" col-lg-5">
                <div class="card shadow mb-4">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col text-center">
                        <p class="btn btn-sm btn-info p-2 mb-5 text-white text-center">Tahun : <span>Sisi Bawah</span></p>
                      </div>
                    </div>
                  </div>
                </div>
