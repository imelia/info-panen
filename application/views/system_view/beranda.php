    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <h3><p>Grafik dibawah merupakan hasil rekap panen dari padi palawija, sayuran, buah, dan biofarmaka. Sehingga masyarakat dapat melihat grafik dari tahun pertahun.</p></h3>
        </div>
...
<!-------------------------- DATA HARGA --------------------------------------------->
    ...
    <section id="about" class="about">
      ...
      <div class="section-title">
          <h2>Komoditas</h2>
          <h3><p>Beberapa komoditas yang ada di Kabupaten Probolinggo.</p></h3>
      </div>
        <div class="container">
      ...
      ?>
        ...
        <section id="resume" class="resume">
          <div class="container" data-aos="fade-up">
            ...
            <div class="section-title">
              <h2>Info Hama</h2>
              <h4><p>Hama adalah hewan yang merusak tanaman atau hasil tanaman atau tanaman karena aktivitas hidupnya, terutama yang disebabkan oleh aktivitas pengumpulan makanan. Hama tanaman adalah organisme yang menyerang tanaman untuk mengganggu pertumbuhan dan perkembangannya.</p></h3>
            </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="resume-item">
                  <ul>
                    <h5>Tikus</h5>
                    <li>
                      <h3><p>Tikus biasanya menyerang tanaman padi, dan sering bergerak pada malam hari. Biasanya biji dan tangkai adalah target utama tikus yang menyerang padi. Tikus bisa makan biji-bijian beras dengan gigi tajam Biasanya, tikus membuat lubang di dekat ladang dan bersembunyi di antara semak-semak. </p></h3>
                    </li>
                    <h5>Ulat</h5>
                    <li>
                      <h3><p>Ulat biasanya memakan daun dan batang tanaman. Anda bahkan mungkin sering melihatnya di lingkungan itu.</p></h3>
                    </li>
                  </ul>
                </div>
                <div class="resume-item">
                  <ul>
                    <h5>Walang Sangit</h5>
                    <li>
                    <h3><p>Walang sangit adalah salah satu hama yang agak mengganggu petani. Bau busuk dapat merusak tanaman dengan melompat atau terbang dari satu tanaman ke tanaman lain, melepaskan bau yang tidak menyenangkan.</p></h3>
                    </li>
                    <h5>Wereng</h5>
                    <li>
                    <h3><p>Wereng biasanya menyerang daun dan batang tanaman, menyebabkan tanaman mati. Hama wereng ini adalah salah satu pembawa virus yang menyebabkan penyakit tungsten.</p></h4>
                    </li>
                  </ul>
                </div>
              </div>
              <div class="col-lg-6">
                ...
                <div class="resume-item">
                  <ul>
                    ...
                    <li>
                      <h3><p>Metode ini dapat dianggap sebagai metode tradisional karena tidak menggunakan bahan kimia seperti insektisida tetapi alat seperti sabit, gunting tanaman, dll. Metode ini membutuhkan waktu yang lama, hasilnya tidak optimal karena perkembangan hama dan penyakit pada tanaman yang banyak digunakan.</p></h3>
                    </li>
                    <h5>Pengendalian Biologis</h5>
                    <li>
                      <h3><p>Mengendalikan hama dan penyakit tanaman secara biologis adalah mengendalikan hama dengan menggunakan predator untuk memangsa para hama tersebut. Namun, dapat dikatakan bahwa kontrol biologis ini tidak optimal karena predator terkadang sulit ditemukan.</p></h3>
                    </li>
                    <h5>Pengendalian Kimia</h5>
                    <li>
                      <h3><p>Mengendalikan hama dan penyakit tanaman secara kimia adalah cara terakhir apabila cara sebelumnya tidak membuahkan hasil yang maksimal. Pestisida seperti insektisida, fungisida dan herbisida digunakan untuk mengendalikan hama dan penyakit dengan bahan kimia.</p></h3>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <?php foreach ($qr as $key => $data) { ?>
                <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
                  <div class="h-entry">
                    ...
                    <h4> <div class="meta mb-4"><?= $data->sumber ?><span class="mx-2">&bullet;</span><?= $data->tanggal ?><span class="mx-2">&bullet;</span> <a href="<?= $data->link ?>" target="_blank">News</a></div></h4>
                  </div>
                </div>
              <?php
              } ?>
