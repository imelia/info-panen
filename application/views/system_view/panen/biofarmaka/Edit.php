                        ...
                        <div class="row">
                                  ...
                                  <div class="row">
                                      ...
                                      <label>Produksi</label>
                                          <div class="form-group">
                                              <input type="text" name="produksi_biofarmaka" value="<?=$this->input->post('produksi_biofarmaka') ?? $row->produksi_biofarmaka?>" class="form-control">
                                  ...
                                  <div class="row">
                                      ...
                                      <label>Harga</label>
                                          <div class="form-group">
                                              <input type="text" name="harga_biofarmaka" value="<?=$this->input->post('harga_biofarmaka') ?? $row->harga_biofarmaka?>" class="form-control">
