                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <input type="text" name="tanam" value="<?= set_value('tanam') ?>" class="form-control" maxlength="15" onkeypress="return hanyaAngka(event)">
                                                <?= form_error('tanam') ?>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <input type="text" name="panen" value="<?= set_value('panen') ?>" class="form-control">
                                                <?= form_error('panen') ?>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <label>Produksi (GKG)</label>
                                            <div class="form-group">
                                                <input type="text" name="produksi" value="<?= set_value('produksi') ?>" class="form-control">
                                                <?= form_error('produksi') ?>
                                            </div>
                                        </div>
                                    </div>
