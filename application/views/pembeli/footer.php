    ...
    <div class="row">
      <div class="col-md-5">
        ...
        <div class="p-4 mb-3 bg-white">
          ...
          <p class="mb-4">Dusun Krajan Rt 18 Rw 05, Desa Maron Kidul, Kabupaten Probolinggo</p>

          <p class="mb-0 font-weight-bold">Nomor Handphone</p>
          <p class="mb-4"><a href="#">+6282213666744</a></p>

          <p class="mb-0 font-weight-bold">Alamat Email</p>
          <p class="mb-0"><a href="#">infopanen@gmail.com</a></p>
...
<script src="<?php echo base_url('assets8/js/jquery.countdown.min.js'); ?>"></script>
<script src="<?php echo base_url('assets8/js/bootstrap-datepicker.min.js'); ?>"></script>
<script src="<?php echo base_url('assets8/js/jquery.easing.1.3.js'); ?>"></script>
<script src="<?php echo base_url('assets8/js/aos.js'); ?>"></script>
<script src="<?php echo base_url('assets8/js/jquery.fancybox.min.js'); ?>"></script>
<script src="<?php echo base_url('assets8/js/jquery.sticky.js'); ?>"></script>


<script src="<?php echo base_url('assets8/js/main.js'); ?>"></script>
